...
for crystal in crystals:
    ...
    output_dir = f'{crystal}_ase_bfgs_calculations'
    ...
    try:
        ...
        opt = BFGS(f, trajectory=traj_filename, logfile=log_filename)


        # It will call the calculator (Espresso) at each step.
        opt.run(fmax=fmax_threshold)
